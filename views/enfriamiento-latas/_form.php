...
<div class="enfriamiento-latas-form">
    ...
    <?= $form->field($model, 'cochesNoIncluir')->textInput(['readonly'=>true]) ?>

    <div class="form-group">
        <?= Html::submitButton('Guardar', ['class' => 'btn btn-success','id' => 'btnGuardarValid']) ?>
...
<script type="text/javascript">
    function buscarDetalle(fechaProduccion, autoclaveProduccion, paradaProduccion, turnoProduccion) {
        $.get('buscardetalle',{ fechaproduccion : fechaProduccion, autoclave : autoclaveProduccion, parada : paradaProduccion, turno : turnoProduccion}, function(data){
            var result = $.parseJSON(data);
            if (result.length == 0)
            {
